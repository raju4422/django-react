...
function Categories() {
 ...
 function parentStateUpdate(value){
  setIsCategoryCreated(value)
 }
              ...
              {listCategories.length > 0 ? (
                listCategories.map((category) => (
                  <tr key={category.id}>
                    ...
                    <td>
                      <i className="actionIcon bi bi-pencil-square" onClick={()=>{navigate('/admin/categories/edit/'+category.id)}}></i>&nbsp;
                      <i
